...
type ContactDefinition interface {
	...
	Store(request *models.ContactsRequest) (responses bool, err error)
...
func (contact ContactRepository) Store(request *models.ContactsRequest) (responses bool, err error) {
	return responses, contact.db.DB.Save(&responses).Error
}
...
func (Contact ContactRepository) Update(request *models.ContactsRequest) (responses bool, err error) {
	return true, Contact.db.DB.Save(&responses).Error
}
