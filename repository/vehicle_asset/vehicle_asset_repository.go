...
type VehicleAssetDefinition interface {
	...
	Store(request *models.VehicleAssetsRequest) (responses bool, err error)
...
func (vehicleAsset VehicleAssetRepository) Store(request *models.VehicleAssetsRequest) (responses bool, err error) {
	return responses, vehicleAsset.db.DB.Save(&responses).Error
}
