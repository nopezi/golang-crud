...
type AssetAccessPlaceDefinition interface {
	...
	Store(request *models.AssetAccessPlacesRequest) (responses bool, err error)
...
func (assetAccessPlace AssetAccessPlaceRepository) Store(request *models.AssetAccessPlacesRequest) (responses bool, err error) {
	return responses, assetAccessPlace.db.DB.Save(&responses).Error
}
...
func (assetAccessPlace AssetAccessPlaceRepository) Update(request *models.AssetAccessPlacesRequest) (responses bool, err error) {
	return true, assetAccessPlace.db.DB.Save(&responses).Error
}
